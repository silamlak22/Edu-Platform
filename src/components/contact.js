                        ...
                        <div className="row">
                            <div className="contact-text col-sm-5">
                                ...
                                <div className="form-container">
                                    ...
                                    <select>
                                        <option value="ethio" selected>Ethiopia</option> 
                                ...
                                <div className="address-detail mt-3">
                                    <p><span style={{fontWeight:"bold"}}>Address :  </span> Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                </div>

                                <div className="tel-detail mt-3"><p><span style={{fontWeight:"bold"}}>Tel :  </span> +1-800-xxxx-xxxx-xxx1 +1-800-xxxx-xxxx-xxx2</p></div>
                            </div>
